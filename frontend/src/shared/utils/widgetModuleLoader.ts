 ...
 *
 * The URL is a real served path (`/widget-js/…`, `/builtin-widgets-js/…`) and
 * must stay `@vite-ignore`d so the bundler leaves it alone.
 *
 ...
 * jsdom has no such URL to fetch, so a test rendering a built-in widget would
