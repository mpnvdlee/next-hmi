...
export default function ComponentsView() {
  ...
  function patchActiveComponent(patch: Partial<ComponentDefinition>) {
    ...
    // The schema editor's name, description and category fields write per
    // keystroke, so a burst of them has to land as one undo step.
    saveComponent(updated, 'structure', 'coalesce');
  }
