...
**To agree: `git commit -s`.** That's the whole process.

**In plain English:**

- You keep the copyright in your work and can use it anywhere else. Nothing here
  transfers ownership.
- You let NEXT HMI ship your contribution under any licence — which is what
  makes the AGPL-3.0 + commercial dual licence possible.
- In return, NEXT HMI must keep your contribution available under whatever
  licence the project used on the day you submitted it. It cannot be taken
  closed-source retroactively.

The text below is the unmodified **Harmony Individual Contributor License
Agreement v1.0** with Outbound License **Option Five**. Contributing on behalf
of a company? Use [CLA-ENTITY.md](CLA-ENTITY.md) instead.
...
Based on the Harmony Individual Contributor License Agreement v1.0 by
