...
Use this when employees contribute as part of their job. Contributing as a
private individual? Use [CLA.md](CLA.md) instead.

**To agree:** an authorised signatory fills in the signature block at the bottom
and emails the signed file to <licensing@next-hmi.com>, once. After that employees
just `git commit -s`.

**In plain English:** the entity keeps the copyright in its contributions and
can use them anywhere else; NEXT HMI gets the right to ship them under any
licence, which is what makes the AGPL-3.0 + commercial dual licence possible.
In return NEXT HMI must keep them available under whatever licence the project
used on the submission date.

The text below is the unmodified **Harmony Entity Contributor License Agreement
v1.0** with Outbound License **Option Five**.

---

## Harmony Entity Contributor License Agreement

Thank you for your interest in contributing to NEXT HMI ("We" or "Us").
...
at [CONTRIBUTING.md § Sign off your commits](CONTRIBUTING.md#sign-off-your-commits).
...
[CONTRIBUTING.md § Sign off your commits](CONTRIBUTING.md#sign-off-your-commits).
...
Creative Commons Attribution 4.0 International (CC BY 4.0) (including any right
...
of the Netherlands excluding its conflicts of law provisions. Under certain
...
Us
________________________
Name: Mark van der Lee
Title: Project owner, NEXT HMI
Address:________________________
________________________
```
...
Based on the Harmony Entity Contributor License Agreement v1.0 by
[Project Harmony](https://www.harmonyagreements.org/), used under a
[Creative Commons Attribution 3.0 Unported License](https://creativecommons.org/licenses/by/3.0/).
Modified only to complete the template's fill-in fields and to select Outbound
License Option Five.
